...
import com.example.erp.wms.ofbiz.domain.ProductFeature;
import com.example.erp.wms.ofbiz.service.ProductFeatureService;
...
@RestController
@RequestMapping("/ofbiz/product-features")
