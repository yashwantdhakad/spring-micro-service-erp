...
import com.example.erp.wms.ofbiz.domain.DocumentType;
import com.example.erp.wms.ofbiz.service.DocumentTypeService;
...
public class DocumentTypeController {
    ...
    public ResponseEntity<DocumentType> create(@RequestBody DocumentType entity) {
        DocumentType created = service.create(entity);
        return ResponseEntity.status(HttpStatus.CREATED).body(created);
    }

    @PutMapping("/{id}")
    public DocumentType update(@PathVariable Long id, @RequestBody DocumentType entity) {
