...
import com.example.erp.wms.ofbiz.domain.CostComponentType;
import com.example.erp.wms.ofbiz.service.CostComponentTypeService;
...
@RestController
@RequestMapping("/ofbiz/cost-component-types")
