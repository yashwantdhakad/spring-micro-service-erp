...
import com.example.erp.wms.ofbiz.domain.ShipmentPackageRouteSeg;
import com.example.erp.wms.ofbiz.service.ShipmentPackageRouteSegService;
...
@RestController
@RequestMapping("/ofbiz/shipment-package-route-segs")
