...
import com.monash.erp.wms.repository.TarpittedLoginViewRepository;
...
public class TarpittedLoginViewService {
    ...
    public TarpittedLoginView get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "TarpittedLoginView %d not found".formatted(id)));
    }
