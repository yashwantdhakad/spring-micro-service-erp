...
import com.monash.erp.wms.repository.VisualThemeResourceRepository;
...
public class VisualThemeResourceService {
    ...
    public VisualThemeResource get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "VisualThemeResource %d not found".formatted(id)));
    }
