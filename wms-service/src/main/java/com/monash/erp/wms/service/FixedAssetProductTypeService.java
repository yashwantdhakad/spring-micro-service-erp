...
import com.monash.erp.wms.repository.FixedAssetProductTypeRepository;
...
public class FixedAssetProductTypeService {
    ...
    public FixedAssetProductType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FixedAssetProductType %d not found".formatted(id)));
    }
