...
import com.monash.erp.wms.repository.SettlementTermRepository;
...
public class SettlementTermService {
    ...
    public SettlementTerm get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "SettlementTerm %d not found".formatted(id)));
    }
