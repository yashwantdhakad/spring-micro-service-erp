...
import com.monash.erp.wms.repository.FixedAssetProductRepository;
...
public class FixedAssetProductService {
    ...
    public FixedAssetProduct get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FixedAssetProduct %d not found".formatted(id)));
    }
