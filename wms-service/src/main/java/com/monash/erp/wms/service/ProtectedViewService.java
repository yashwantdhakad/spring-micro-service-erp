...
import com.monash.erp.wms.repository.ProtectedViewRepository;
...
public class ProtectedViewService {
    ...
    public ProtectedView get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "ProtectedView %d not found".formatted(id)));
    }
