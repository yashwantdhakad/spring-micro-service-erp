...
import com.monash.erp.wms.repository.PortletCategoryRepository;
...
public class PortletCategoryService {
    ...
    public PortletCategory get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PortletCategory %d not found".formatted(id)));
    }
