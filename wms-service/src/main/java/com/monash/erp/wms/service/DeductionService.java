...
import com.monash.erp.wms.repository.DeductionRepository;
...
public class DeductionService {
    ...
    public Deduction get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Deduction %d not found".formatted(id)));
    }
