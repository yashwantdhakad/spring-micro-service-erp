...
import com.monash.erp.wms.repository.EmailTemplateSettingRepository;
...
public class EmailTemplateSettingService {
    ...
    public EmailTemplateSetting get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "EmailTemplateSetting %d not found".formatted(id)));
    }
