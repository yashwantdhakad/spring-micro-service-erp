...
import com.monash.erp.wms.repository.FixedAssetRegistrationRepository;
...
public class FixedAssetRegistrationService {
    ...
    public FixedAssetRegistration get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FixedAssetRegistration %d not found".formatted(id)));
    }
