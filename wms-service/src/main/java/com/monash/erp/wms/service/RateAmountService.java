...
import com.monash.erp.wms.entity.RateAmount;
import com.monash.erp.wms.repository.RateAmountRepository;
...
public class RateAmountService {
    ...
    public RateAmount get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "RateAmount %d not found".formatted(id)));
    }
