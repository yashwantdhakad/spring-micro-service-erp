...
import com.monash.erp.wms.repository.EftAccountRepository;
...
public class EftAccountService {
    ...
    public EftAccount get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "EftAccount %d not found".formatted(id)));
    }
