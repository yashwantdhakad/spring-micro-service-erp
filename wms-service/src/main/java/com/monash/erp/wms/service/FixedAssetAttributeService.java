...
import com.monash.erp.wms.repository.FixedAssetAttributeRepository;
...
public class FixedAssetAttributeService {
    ...
    public FixedAssetAttribute get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FixedAssetAttribute %d not found".formatted(id)));
    }
