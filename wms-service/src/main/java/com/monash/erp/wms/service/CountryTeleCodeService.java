...
import com.monash.erp.wms.entity.CountryTeleCode;
import com.monash.erp.wms.repository.CountryTeleCodeRepository;
...
public class CountryTeleCodeService {
    ...
    public CountryTeleCode get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "CountryTeleCode %d not found".formatted(id)));
    }
