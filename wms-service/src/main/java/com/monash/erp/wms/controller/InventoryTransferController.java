...
import com.monash.erp.wms.service.InventoryTransferService;
...
public class InventoryTransferController {
    ...
    @GetMapping("/{id}")
    public InventoryTransfer get(@PathVariable Long id) {
        return service.get(id);
    }

    @PostMapping
    public ResponseEntity<InventoryTransfer> create(@RequestBody InventoryTransfer entity) {
        InventoryTransfer created = service.create(entity);
        return ResponseEntity.status(HttpStatus.CREATED).body(created);
    }

    @PutMapping("/{id}")
    public InventoryTransfer update(@PathVariable Long id, @RequestBody InventoryTransfer entity) {
