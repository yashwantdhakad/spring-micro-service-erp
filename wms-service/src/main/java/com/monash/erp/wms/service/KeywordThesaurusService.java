...
import com.monash.erp.wms.entity.KeywordThesaurus;
import com.monash.erp.wms.repository.KeywordThesaurusRepository;
...
public class KeywordThesaurusService {
    ...
    public KeywordThesaurus get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "KeywordThesaurus %d not found".formatted(id)));
    }
