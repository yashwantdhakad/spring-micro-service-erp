...
import com.monash.erp.wms.repository.PortalPageColumnRepository;
...
public class PortalPageColumnService {
    ...
    public PortalPageColumn get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PortalPageColumn %d not found".formatted(id)));
    }
