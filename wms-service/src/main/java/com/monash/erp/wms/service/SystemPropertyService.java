...
import com.monash.erp.wms.repository.SystemPropertyRepository;
...
public class SystemPropertyService {
    ...
    public SystemProperty get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "SystemProperty %d not found".formatted(id)));
    }
