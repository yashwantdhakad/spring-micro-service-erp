...
import com.monash.erp.wms.repository.GiftCardFulfillmentRepository;
...
public class GiftCardFulfillmentService {
    ...
    public GiftCardFulfillment get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GiftCardFulfillment %d not found".formatted(id)));
    }
