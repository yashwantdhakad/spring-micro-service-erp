...
import com.monash.erp.wms.repository.CustomMethodTypeRepository;
...
public class CustomMethodTypeService {
    ...
    public CustomMethodType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "CustomMethodType %d not found".formatted(id)));
    }
