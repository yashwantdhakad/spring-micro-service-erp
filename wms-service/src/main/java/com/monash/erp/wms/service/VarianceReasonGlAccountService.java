...
import com.monash.erp.wms.repository.VarianceReasonGlAccountRepository;
...
public class VarianceReasonGlAccountService {
    ...
    public VarianceReasonGlAccount get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "VarianceReasonGlAccount %d not found".formatted(id)));
    }
