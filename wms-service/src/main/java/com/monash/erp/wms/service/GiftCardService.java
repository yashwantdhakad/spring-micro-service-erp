...
import com.monash.erp.wms.entity.GiftCard;
import com.monash.erp.wms.repository.GiftCardRepository;
...
public class GiftCardService {
    ...
    public GiftCard get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GiftCard %d not found".formatted(id)));
    }
