...
import com.monash.erp.wms.entity.FixedAssetDepMethod;
import com.monash.erp.wms.repository.FixedAssetDepMethodRepository;
...
public class FixedAssetDepMethodService {
    ...
    public FixedAssetDepMethod get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FixedAssetDepMethod %d not found".formatted(id)));
    }
