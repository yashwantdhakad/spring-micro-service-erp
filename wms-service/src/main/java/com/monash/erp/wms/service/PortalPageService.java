...
import com.monash.erp.wms.repository.PortalPageRepository;
...
public class PortalPageService {
    ...
    public PortalPage get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PortalPage %d not found".formatted(id)));
    }
