...
import com.monash.erp.wms.entity.FixedAssetStdCost;
import com.monash.erp.wms.repository.FixedAssetStdCostRepository;
...
public class FixedAssetStdCostService {
    ...
    public FixedAssetStdCost get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FixedAssetStdCost %d not found".formatted(id)));
    }
