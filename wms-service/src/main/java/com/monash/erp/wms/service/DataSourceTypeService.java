...
import com.monash.erp.wms.repository.DataSourceTypeRepository;
...
public class DataSourceTypeService {
    ...
    public DataSourceType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "DataSourceType %d not found".formatted(id)));
    }
