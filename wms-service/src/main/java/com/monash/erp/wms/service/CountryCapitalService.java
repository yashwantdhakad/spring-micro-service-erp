...
import com.monash.erp.wms.repository.CountryCapitalRepository;
...
public class CountryCapitalService {
    ...
    public CountryCapital get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "CountryCapital %d not found".formatted(id)));
    }
