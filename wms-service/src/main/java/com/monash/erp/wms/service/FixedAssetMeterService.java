...
import com.monash.erp.wms.entity.FixedAssetMeter;
import com.monash.erp.wms.repository.FixedAssetMeterRepository;
...
public class FixedAssetMeterService {
    ...
    public FixedAssetMeter get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FixedAssetMeter %d not found".formatted(id)));
    }
