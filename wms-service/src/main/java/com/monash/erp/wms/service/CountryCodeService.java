...
import com.monash.erp.wms.repository.CountryCodeRepository;
...
public class CountryCodeService {
    ...
    public CountryCode get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "CountryCode %d not found".formatted(id)));
    }
