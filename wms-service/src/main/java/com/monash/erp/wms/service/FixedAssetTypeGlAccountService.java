...
import com.monash.erp.wms.entity.FixedAssetTypeGlAccount;
import com.monash.erp.wms.repository.FixedAssetTypeGlAccountRepository;
...
public class FixedAssetTypeGlAccountService {
    ...
    public FixedAssetTypeGlAccount get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FixedAssetTypeGlAccount %d not found".formatted(id)));
    }
