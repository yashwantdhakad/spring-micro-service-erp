...
import com.monash.erp.wms.repository.FixedAssetIdentTypeRepository;
...
public class FixedAssetIdentTypeService {
    ...
    public FixedAssetIdentType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FixedAssetIdentType %d not found".formatted(id)));
    }
