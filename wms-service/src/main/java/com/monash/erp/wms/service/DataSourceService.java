...
import com.monash.erp.wms.repository.DataSourceRepository;
...
public class DataSourceService {
    ...
    public DataSource get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "DataSource %d not found".formatted(id)));
    }
