...
import com.monash.erp.wms.repository.PortalPortletRepository;
...
public class PortalPortletService {
    ...
    public PortalPortlet get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PortalPortlet %d not found".formatted(id)));
    }
