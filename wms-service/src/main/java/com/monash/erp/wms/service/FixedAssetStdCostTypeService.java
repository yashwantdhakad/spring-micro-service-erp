...
import com.monash.erp.wms.repository.FixedAssetStdCostTypeRepository;
...
public class FixedAssetStdCostTypeService {
    ...
    public FixedAssetStdCostType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FixedAssetStdCostType %d not found".formatted(id)));
    }
