...
import com.monash.erp.wms.repository.FixedAssetMaintRepository;
...
public class FixedAssetMaintService {
    ...
    public FixedAssetMaint get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FixedAssetMaint %d not found".formatted(id)));
    }
