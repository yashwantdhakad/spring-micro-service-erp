...
import com.monash.erp.party.security.repository.UserPreferenceRepository;
...
public class UserPreferenceService {
    ...
    public UserPreference get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "UserPreference %d not found".formatted(id)));
    }
