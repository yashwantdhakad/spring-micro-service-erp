...
describe('PartyService', () => {
  ...
  it('should fetch customers', async () => {
    ...
    const req = httpTestingController.expectOne('/oms/api/customers?page=1&query=keyword');
  ...
  it('should create a customer', async () => {
    ...
    const req = httpTestingController.expectOne('/oms/api/customers');
  ...
  it('should fetch a customer', async () => {
    ...
    const req = httpTestingController.expectOne('/oms/api/customers/1');
    expect(req.request.method).toBe('GET');
    req.flush(mockResponse);
  ...
  it('should fetch suppliers', async () => {
    ...
    const req = httpTestingController.expectOne('/oms/api/suppliers?page=1&query=keyword');
    expect(req.request.method).toBe('GET');
    req.flush(mockResponse);
  ...
  it('should create a supplier', async () => {
    ...
    const req = httpTestingController.expectOne('/oms/api/suppliers');
    expect(req.request.method).toBe('POST');
    req.flush(mockResponse);
  ...
  it('should fetch a supplier', async () => {
    ...
    const req = httpTestingController.expectOne('/oms/api/suppliers/1');
    expect(req.request.method).toBe('GET');
    req.flush(mockResponse);
  ...
  it('should update customer detail', async () => {
    ...
    const req = httpTestingController.expectOne('/oms/api/customers/CUST1');
  ...
  it('should update supplier detail', async () => {
    ...
    const req = httpTestingController.expectOne('/oms/api/suppliers/SUPP1');
    expect(req.request.method).toBe('PUT');
    req.flush(mockResponse);
  ...
  it('should update address', async () => {
    ...
    const req = httpTestingController.expectOne('/oms/api/parties/CUST1/postal-addresses/CM1');
    expect(req.request.method).toBe('PUT');
    req.flush(mockResponse);
  ...
  it('should update phone number', async () => {
    ...
    const req = httpTestingController.expectOne('/oms/api/parties/CUST1/telecom-numbers/CM1');
    expect(req.request.method).toBe('PUT');
    req.flush(mockResponse);
  ...
  it('should add email', async () => {
    ...
    const req = httpTestingController.expectOne('/oms/api/parties/CUST1/emails');
    expect(req.request.method).toBe('POST');
    req.flush(mockResponse);
  ...
  it('should add phone', async () => {
    ...
    const req = httpTestingController.expectOne('/oms/api/parties/CUST1/telecom-numbers');
    expect(req.request.method).toBe('POST');
    req.flush(mockResponse);
  ...
  it('should add role', async () => {
    ...
    const req = httpTestingController.expectOne('/oms/api/party-roles');
    expect(req.request.method).toBe('POST');
    req.flush(mockResponse);
  ...
  it('should create party note', async () => {
    ...
    const req = httpTestingController.expectOne('/oms/api/parties/CUST1/notes');
    expect(req.request.method).toBe('POST');
    req.flush(mockResponse);
  ...
  it('should update party note', async () => {
    ...
    const req = httpTestingController.expectOne('/oms/api/parties/CUST1/notes/N1');
    expect(req.request.method).toBe('PUT');
    req.flush(mockResponse);
