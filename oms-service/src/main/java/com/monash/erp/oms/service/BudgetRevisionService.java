...
import com.monash.erp.oms.repository.BudgetRevisionRepository;
...
public class BudgetRevisionService {
    ...
    public BudgetRevision get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "BudgetRevision %d not found".formatted(id)));
    }
