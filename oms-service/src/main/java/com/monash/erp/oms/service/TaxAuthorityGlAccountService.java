...
import com.monash.erp.oms.repository.TaxAuthorityGlAccountRepository;
...
public class TaxAuthorityGlAccountService {
    ...
    public TaxAuthorityGlAccount get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "TaxAuthorityGlAccount %d not found".formatted(id)));
    }
