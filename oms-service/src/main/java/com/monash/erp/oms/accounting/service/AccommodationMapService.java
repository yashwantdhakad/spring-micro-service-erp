...
import com.monash.erp.oms.accounting.entity.AccommodationMap;
import com.monash.erp.oms.accounting.repository.AccommodationMapRepository;
...
public class AccommodationMapService {
    ...
    public AccommodationMap get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "AccommodationMap %d not found".formatted(id)));
    }
