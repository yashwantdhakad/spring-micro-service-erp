...
import com.monash.erp.oms.repository.GlXbrlClassRepository;
...
public class GlXbrlClassService {
    ...
    public GlXbrlClass get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlXbrlClass %d not found".formatted(id)));
    }
