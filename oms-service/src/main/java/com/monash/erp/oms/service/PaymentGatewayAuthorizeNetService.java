...
import com.monash.erp.oms.repository.PaymentGatewayAuthorizeNetRepository;
...
public class PaymentGatewayAuthorizeNetService {
    ...
    public PaymentGatewayAuthorizeNet get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PaymentGatewayAuthorizeNet %d not found".formatted(id)));
    }
