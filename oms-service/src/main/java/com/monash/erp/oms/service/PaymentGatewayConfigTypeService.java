...
import com.monash.erp.oms.repository.PaymentGatewayConfigTypeRepository;
...
public class PaymentGatewayConfigTypeService {
    ...
    public PaymentGatewayConfigType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PaymentGatewayConfigType %d not found".formatted(id)));
    }
