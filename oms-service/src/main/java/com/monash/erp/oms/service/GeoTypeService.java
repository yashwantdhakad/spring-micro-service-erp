...
import com.monash.erp.oms.entity.GeoType;
import com.monash.erp.oms.repository.GeoTypeRepository;
...
public class GeoTypeService {
    ...
    public GeoType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GeoType %d not found".formatted(id)));
    }
