...
import com.monash.erp.oms.entity.PaymentGatewayClearCommerce;
import com.monash.erp.oms.repository.PaymentGatewayClearCommerceRepository;
...
public class PaymentGatewayClearCommerceService {
    ...
    public PaymentGatewayClearCommerce get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PaymentGatewayClearCommerce %d not found".formatted(id)));
    }
