...
import com.monash.erp.oms.party.entity.ContactMechPurposeType;
import com.monash.erp.oms.party.service.ContactMechPurposeTypeService;
...
@RestController
@RequestMapping("/api/contact-mech-purpose-types")
