...
import com.monash.erp.oms.repository.AcctgTransRepository;
...
public class AcctgTransService {
    ...
    public AcctgTrans get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "AcctgTrans %d not found".formatted(id)));
    }
