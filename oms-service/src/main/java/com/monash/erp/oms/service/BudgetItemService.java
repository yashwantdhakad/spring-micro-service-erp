...
import com.monash.erp.oms.repository.BudgetItemRepository;
...
public class BudgetItemService {
    ...
    public BudgetItem get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "BudgetItem %d not found".formatted(id)));
    }
