...
import com.monash.erp.oms.entity.FinAccountTypeAttr;
import com.monash.erp.oms.repository.FinAccountTypeAttrRepository;
...
public class FinAccountTypeAttrService {
    ...
    public FinAccountTypeAttr get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FinAccountTypeAttr %d not found".formatted(id)));
    }
