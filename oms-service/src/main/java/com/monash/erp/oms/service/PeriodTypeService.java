...
import com.monash.erp.oms.entity.PeriodType;
import com.monash.erp.oms.repository.PeriodTypeRepository;
...
public class PeriodTypeService {
    ...
    public PeriodType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PeriodType %d not found".formatted(id)));
    }
