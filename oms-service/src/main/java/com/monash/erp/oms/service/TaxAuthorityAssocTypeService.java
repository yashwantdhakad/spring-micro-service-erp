...
import com.monash.erp.oms.repository.TaxAuthorityAssocTypeRepository;
...
public class TaxAuthorityAssocTypeService {
    ...
    public TaxAuthorityAssocType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "TaxAuthorityAssocType %d not found".formatted(id)));
    }
