...
import com.monash.erp.oms.repository.UomConversionRepository;
...
public class UomConversionService {
    ...
    public UomConversion get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "UomConversion %d not found".formatted(id)));
    }
