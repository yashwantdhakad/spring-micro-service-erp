...
import com.monash.erp.oms.repository.PaymentGroupRepository;
...
public class PaymentGroupService {
    ...
    public PaymentGroup get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PaymentGroup %d not found".formatted(id)));
    }
