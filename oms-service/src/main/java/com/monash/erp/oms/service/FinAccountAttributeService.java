...
import com.monash.erp.oms.repository.FinAccountAttributeRepository;
...
public class FinAccountAttributeService {
    ...
    public FinAccountAttribute get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FinAccountAttribute %d not found".formatted(id)));
    }
