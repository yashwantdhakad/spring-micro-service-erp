...
import com.monash.erp.oms.repository.UomConversionDatedRepository;
...
public class UomConversionDatedService {
    ...
    public UomConversionDated get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "UomConversionDated %d not found".formatted(id)));
    }
