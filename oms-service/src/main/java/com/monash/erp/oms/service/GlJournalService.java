...
import com.monash.erp.oms.repository.GlJournalRepository;
...
public class GlJournalService {
    ...
    public GlJournal get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlJournal %d not found".formatted(id)));
    }
