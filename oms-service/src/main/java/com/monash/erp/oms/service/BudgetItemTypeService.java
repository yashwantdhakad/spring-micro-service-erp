...
import com.monash.erp.oms.repository.BudgetItemTypeRepository;
...
public class BudgetItemTypeService {
    ...
    public BudgetItemType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "BudgetItemType %d not found".formatted(id)));
    }
