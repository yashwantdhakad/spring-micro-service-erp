...
import com.monash.erp.oms.repository.GlAccountRoleRepository;
...
public class GlAccountRoleService {
    ...
    public GlAccountRole get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlAccountRole %d not found".formatted(id)));
    }
