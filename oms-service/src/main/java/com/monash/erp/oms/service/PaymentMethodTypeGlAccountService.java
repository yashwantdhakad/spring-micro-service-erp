...
import com.monash.erp.oms.repository.PaymentMethodTypeGlAccountRepository;
...
public class PaymentMethodTypeGlAccountService {
    ...
    public PaymentMethodTypeGlAccount get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PaymentMethodTypeGlAccount %d not found".formatted(id)));
    }
