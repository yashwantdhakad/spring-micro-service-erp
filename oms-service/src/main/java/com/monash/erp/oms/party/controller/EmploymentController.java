...
import com.monash.erp.oms.party.service.EmploymentService;
...
public class EmploymentController {
    ...
    @PostMapping
    public ResponseEntity<Employment> create(@RequestBody Employment entity) {
        Employment created = service.create(entity);
        return ResponseEntity.status(HttpStatus.CREATED).body(created);
    }

    @PutMapping("/{id}")
    public Employment update(@PathVariable Long id, @RequestBody Employment entity) {
