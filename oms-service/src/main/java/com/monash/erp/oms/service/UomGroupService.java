...
import com.monash.erp.oms.entity.UomGroup;
import com.monash.erp.oms.repository.UomGroupRepository;
...
public class UomGroupService {
    ...
    public UomGroup get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "UomGroup %d not found".formatted(id)));
    }
