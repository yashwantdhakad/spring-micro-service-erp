...
import com.monash.erp.oms.accounting.entity.PaymentGatewayConfigType;
import com.monash.erp.oms.accounting.service.PaymentGatewayConfigTypeService;
...
@RestController
@RequestMapping("/api/accounting/payment-gateway-config-types")
