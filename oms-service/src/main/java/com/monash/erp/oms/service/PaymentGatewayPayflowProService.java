...
import com.monash.erp.oms.entity.PaymentGatewayPayflowPro;
import com.monash.erp.oms.repository.PaymentGatewayPayflowProRepository;
...
public class PaymentGatewayPayflowProService {
    ...
    public PaymentGatewayPayflowPro get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PaymentGatewayPayflowPro %d not found".formatted(id)));
    }
