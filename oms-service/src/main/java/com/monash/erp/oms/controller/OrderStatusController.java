...
import com.monash.erp.oms.service.OrderStatusService;
...
public class OrderStatusController {
    ...
    public ResponseEntity<OrderStatus> create(@RequestBody OrderStatus entity) {
        OrderStatus created = service.create(entity);
        return ResponseEntity.status(HttpStatus.CREATED).body(created);
    }

    @PutMapping("/{id}")
    public OrderStatus update(@PathVariable Long id, @RequestBody OrderStatus entity) {
