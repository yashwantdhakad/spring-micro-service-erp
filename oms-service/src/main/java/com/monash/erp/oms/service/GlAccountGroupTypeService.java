...
import com.monash.erp.oms.entity.GlAccountGroupType;
import com.monash.erp.oms.repository.GlAccountGroupTypeRepository;
...
public class GlAccountGroupTypeService {
    ...
    public GlAccountGroupType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlAccountGroupType %d not found".formatted(id)));
    }
