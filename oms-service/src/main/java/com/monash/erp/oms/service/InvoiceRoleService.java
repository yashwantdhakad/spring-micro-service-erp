...
import com.monash.erp.oms.repository.InvoiceRoleRepository;
...
public class InvoiceRoleService {
    ...
    public InvoiceRole get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "InvoiceRole %d not found".formatted(id)));
    }
