...
import com.monash.erp.oms.accounting.entity.FinAccountTransAttribute;
import com.monash.erp.oms.accounting.repository.FinAccountTransAttributeRepository;
...
public class FinAccountTransAttributeService {
    ...
    public FinAccountTransAttribute get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FinAccountTransAttribute %d not found".formatted(id)));
    }
