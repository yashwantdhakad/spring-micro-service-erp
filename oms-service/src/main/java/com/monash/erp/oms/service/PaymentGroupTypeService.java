...
import com.monash.erp.oms.entity.PaymentGroupType;
import com.monash.erp.oms.repository.PaymentGroupTypeRepository;
...
public class PaymentGroupTypeService {
    ...
    public PaymentGroupType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PaymentGroupType %d not found".formatted(id)));
    }
