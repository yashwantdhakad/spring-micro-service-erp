...
import com.monash.erp.oms.repository.PaymentGatewayConfigRepository;
...
public class PaymentGatewayConfigService {
    ...
    public PaymentGatewayConfig get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PaymentGatewayConfig %d not found".formatted(id)));
    }
