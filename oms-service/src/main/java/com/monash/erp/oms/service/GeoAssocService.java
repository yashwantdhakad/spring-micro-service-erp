...
import com.monash.erp.oms.entity.GeoAssoc;
import com.monash.erp.oms.repository.GeoAssocRepository;
...
public class GeoAssocService {
    ...
    public GeoAssoc get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GeoAssoc %d not found".formatted(id)));
    }
