...
import com.monash.erp.oms.entity.UomType;
import com.monash.erp.oms.repository.UomTypeRepository;
...
public class UomTypeService {
    ...
    public UomType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "UomType %d not found".formatted(id)));
    }
