...
import com.monash.erp.oms.repository.GlReconciliationEntryRepository;
...
public class GlReconciliationEntryService {
    ...
    public GlReconciliationEntry get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlReconciliationEntry %d not found".formatted(id)));
    }
