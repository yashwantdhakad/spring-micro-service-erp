...
import com.monash.erp.oms.entity.BudgetItemTypeAttr;
import com.monash.erp.oms.repository.BudgetItemTypeAttrRepository;
...
public class BudgetItemTypeAttrService {
    ...
    public BudgetItemTypeAttr get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "BudgetItemTypeAttr %d not found".formatted(id)));
    }
