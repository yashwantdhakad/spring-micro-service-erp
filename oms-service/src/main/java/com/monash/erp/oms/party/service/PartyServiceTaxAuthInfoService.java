...
import com.monash.erp.oms.party.repository.PartyServiceTaxAuthInfoRepository;
...
@Service
public class PartyServiceTaxAuthInfoService {

    private final PartyServiceTaxAuthInfoRepository repository;

    public PartyServiceTaxAuthInfoService(PartyServiceTaxAuthInfoRepository repository) {
    ...
    public PartyTaxAuthInfo get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND,
                        "PartyTaxAuthInfo %d not found".formatted(id)));
    }
