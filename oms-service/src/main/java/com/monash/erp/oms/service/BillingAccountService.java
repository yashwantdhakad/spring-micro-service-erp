...
import com.monash.erp.oms.repository.BillingAccountRepository;
...
public class BillingAccountService {
    ...
    public BillingAccount get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "BillingAccount %d not found".formatted(id)));
    }
