...
import com.monash.erp.oms.repository.GlResourceTypeRepository;
...
public class GlResourceTypeService {
    ...
    public GlResourceType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlResourceType %d not found".formatted(id)));
    }
