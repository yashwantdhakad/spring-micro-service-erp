...
import com.monash.erp.oms.repository.PaymentBudgetAllocationRepository;
...
public class PaymentBudgetAllocationService {
    ...
    public PaymentBudgetAllocation get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PaymentBudgetAllocation %d not found".formatted(id)));
    }
