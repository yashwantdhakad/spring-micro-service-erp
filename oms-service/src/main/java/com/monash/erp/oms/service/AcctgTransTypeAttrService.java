...
import com.monash.erp.oms.entity.AcctgTransTypeAttr;
import com.monash.erp.oms.repository.AcctgTransTypeAttrRepository;
...
public class AcctgTransTypeAttrService {
    ...
    public AcctgTransTypeAttr get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "AcctgTransTypeAttr %d not found".formatted(id)));
    }
