...
import com.monash.erp.oms.repository.GlAccountClassRepository;
...
public class GlAccountClassService {
    ...
    public GlAccountClass get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlAccountClass %d not found".formatted(id)));
    }
