...
import com.monash.erp.oms.repository.BillingAccountTermRepository;
...
public class BillingAccountTermService {
    ...
    public BillingAccountTerm get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "BillingAccountTerm %d not found".formatted(id)));
    }
