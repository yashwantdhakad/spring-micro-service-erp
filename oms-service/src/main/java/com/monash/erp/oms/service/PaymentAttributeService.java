...
import com.monash.erp.oms.repository.PaymentAttributeRepository;
...
public class PaymentAttributeService {
    ...
    public PaymentAttribute get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PaymentAttribute %d not found".formatted(id)));
    }
