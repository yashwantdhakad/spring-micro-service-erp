...
import com.monash.erp.oms.repository.PaymentMethodTypeRepository;
...
public class PaymentMethodTypeService {
    ...
    public PaymentMethodType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PaymentMethodType %d not found".formatted(id)));
    }
