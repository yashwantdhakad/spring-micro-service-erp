...
import com.monash.erp.oms.repository.AcctgTransEntryRepository;
...
public class AcctgTransEntryService {
    ...
    public AcctgTransEntry get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "AcctgTransEntry %d not found".formatted(id)));
    }
