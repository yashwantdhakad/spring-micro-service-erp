...
import com.monash.erp.oms.entity.FinAccountTypeGlAccount;
import com.monash.erp.oms.repository.FinAccountTypeGlAccountRepository;
...
public class FinAccountTypeGlAccountService {
    ...
    public FinAccountTypeGlAccount get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FinAccountTypeGlAccount %d not found".formatted(id)));
    }
