...
import com.monash.erp.oms.repository.InvoiceTypeAttrRepository;
...
public class InvoiceTypeAttrService {
    ...
    public InvoiceTypeAttr get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "InvoiceTypeAttr %d not found".formatted(id)));
    }
