...
import com.monash.erp.oms.entity.BillingAccountRole;
import com.monash.erp.oms.repository.BillingAccountRoleRepository;
...
public class BillingAccountRoleService {
    ...
    public BillingAccountRole get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "BillingAccountRole %d not found".formatted(id)));
    }
