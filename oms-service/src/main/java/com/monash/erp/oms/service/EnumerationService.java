...
import com.monash.erp.oms.repository.EnumerationRepository;
...
public class EnumerationService {
    ...
    public Enumeration get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Enumeration %d not found".formatted(id)));
    }
