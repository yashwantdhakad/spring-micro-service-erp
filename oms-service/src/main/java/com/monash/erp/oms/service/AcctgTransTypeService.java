...
import com.monash.erp.oms.entity.AcctgTransType;
import com.monash.erp.oms.repository.AcctgTransTypeRepository;
...
public class AcctgTransTypeService {
    ...
    public AcctgTransType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "AcctgTransType %d not found".formatted(id)));
    }
