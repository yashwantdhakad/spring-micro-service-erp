...
import com.monash.erp.oms.repository.CustomTimePeriodRepository;
...
public class CustomTimePeriodService {
    ...
    public CustomTimePeriod get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "CustomTimePeriod %d not found".formatted(id)));
    }
