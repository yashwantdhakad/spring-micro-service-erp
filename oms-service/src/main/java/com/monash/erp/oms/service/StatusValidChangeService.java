...
import com.monash.erp.oms.entity.StatusValidChange;
import com.monash.erp.oms.repository.StatusValidChangeRepository;
...
public class StatusValidChangeService {
    ...
    public StatusValidChange get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "StatusValidChange %d not found".formatted(id)));
    }
