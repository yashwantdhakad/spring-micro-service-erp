...
import com.monash.erp.oms.entity.InvoiceContactMech;
import com.monash.erp.oms.repository.InvoiceContactMechRepository;
...
public class InvoiceContactMechService {
    ...
    public InvoiceContactMech get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "InvoiceContactMech %d not found".formatted(id)));
    }
