...
import com.monash.erp.oms.party.service.PartyServiceRateService;
...
public class PartyServiceRateController {

    private final PartyServiceRateService service;

    public PartyServiceRateController(PartyServiceRateService service) {
