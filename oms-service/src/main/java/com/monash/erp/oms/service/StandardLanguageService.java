...
import com.monash.erp.oms.repository.StandardLanguageRepository;
...
public class StandardLanguageService {
    ...
    public StandardLanguage get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "StandardLanguage %d not found".formatted(id)));
    }
