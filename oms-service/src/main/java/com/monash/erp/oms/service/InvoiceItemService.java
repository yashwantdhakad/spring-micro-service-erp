...
import com.monash.erp.oms.repository.InvoiceItemRepository;
...
public class InvoiceItemService {
    ...
    public InvoiceItem get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "InvoiceItem %d not found".formatted(id)));
    }
