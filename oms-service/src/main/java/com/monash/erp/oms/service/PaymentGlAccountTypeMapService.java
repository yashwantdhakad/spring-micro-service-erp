...
import com.monash.erp.oms.entity.PaymentGlAccountTypeMap;
import com.monash.erp.oms.repository.PaymentGlAccountTypeMapRepository;
...
public class PaymentGlAccountTypeMapService {
    ...
    public PaymentGlAccountTypeMap get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PaymentGlAccountTypeMap %d not found".formatted(id)));
    }
