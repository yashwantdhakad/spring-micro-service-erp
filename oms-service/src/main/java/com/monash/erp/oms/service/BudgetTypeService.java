...
import com.monash.erp.oms.repository.BudgetTypeRepository;
...
public class BudgetTypeService {
    ...
    public BudgetType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "BudgetType %d not found".formatted(id)));
    }
