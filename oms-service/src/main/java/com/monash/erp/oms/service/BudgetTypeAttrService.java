...
import com.monash.erp.oms.repository.BudgetTypeAttrRepository;
...
public class BudgetTypeAttrService {
    ...
    public BudgetTypeAttr get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "BudgetTypeAttr %d not found".formatted(id)));
    }
