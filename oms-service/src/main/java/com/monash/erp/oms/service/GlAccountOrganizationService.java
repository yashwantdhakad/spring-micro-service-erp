...
import com.monash.erp.oms.repository.GlAccountOrganizationRepository;
...
public class GlAccountOrganizationService {
    ...
    public GlAccountOrganization get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlAccountOrganization %d not found".formatted(id)));
    }
