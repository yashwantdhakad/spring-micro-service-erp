...
import com.monash.erp.oms.repository.GlBudgetXrefRepository;
...
public class GlBudgetXrefService {
    ...
    public GlBudgetXref get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlBudgetXref %d not found".formatted(id)));
    }
