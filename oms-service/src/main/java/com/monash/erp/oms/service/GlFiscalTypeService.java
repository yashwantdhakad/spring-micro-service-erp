...
import com.monash.erp.oms.repository.GlFiscalTypeRepository;
...
public class GlFiscalTypeService {
    ...
    public GlFiscalType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlFiscalType %d not found".formatted(id)));
    }
