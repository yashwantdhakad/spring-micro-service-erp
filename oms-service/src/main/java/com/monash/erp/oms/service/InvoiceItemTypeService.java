...
import com.monash.erp.oms.repository.InvoiceItemTypeRepository;
...
public class InvoiceItemTypeService {
    ...
    public InvoiceItemType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "InvoiceItemType %d not found".formatted(id)));
    }
