...
import com.monash.erp.oms.entity.GlAccountCategoryMember;
import com.monash.erp.oms.repository.GlAccountCategoryMemberRepository;
...
public class GlAccountCategoryMemberService {
    ...
    public GlAccountCategoryMember get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlAccountCategoryMember %d not found".formatted(id)));
    }
