...
import com.monash.erp.oms.repository.PaymentGatewayWorldPayRepository;
...
public class PaymentGatewayWorldPayService {
    ...
    public PaymentGatewayWorldPay get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PaymentGatewayWorldPay %d not found".formatted(id)));
    }
