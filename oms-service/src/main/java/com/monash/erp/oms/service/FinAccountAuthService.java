...
import com.monash.erp.oms.entity.FinAccountAuth;
import com.monash.erp.oms.repository.FinAccountAuthRepository;
...
public class FinAccountAuthService {
    ...
    public FinAccountAuth get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FinAccountAuth %d not found".formatted(id)));
    }
