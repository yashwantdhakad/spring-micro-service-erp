...
import com.monash.erp.oms.party.dto.CreditCardDTO;
import com.monash.erp.oms.party.dto.PartyDto;
import com.monash.erp.oms.party.entity.*;
import com.monash.erp.oms.party.mapper.PartyMapper;
import com.monash.erp.oms.party.repository.*;
...
public class PartyService {
    ...
    private final PartyServicePaymentMethodRepository paymentMethodRepository;
    ...
    public PartyService(PartyRepository repository,
            PartyMapper mapper,
            PartyServicePaymentMethodRepository paymentMethodRepository,
    ...
    private List<com.monash.erp.oms.party.dto.AddressDto> getPostalAddresses(String partyId) {
                ...
                .map(pcm -> {
                    ...
                    return contactMechRepository.findByContactMechId(pcm.getContactMechId())
                            ...
                            .flatMap(cm -> postalAddressRepository.findByContactMechId(pcm.getContactMechId())
                                    .map(pa -> {
                                        com.monash.erp.oms.party.dto.AddressDto dto = new com.monash.erp.oms.party.dto.AddressDto();
