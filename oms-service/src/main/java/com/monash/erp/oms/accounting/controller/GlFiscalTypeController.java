...
import com.monash.erp.oms.accounting.entity.GlFiscalType;
import com.monash.erp.oms.accounting.service.GlFiscalTypeService;
...
@RestController
@RequestMapping("/api/accounting/gl-fiscal-types")
