...
import com.monash.erp.oms.repository.BudgetAttributeRepository;
...
public class BudgetAttributeService {
    ...
    public BudgetAttribute get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "BudgetAttribute %d not found".formatted(id)));
    }
