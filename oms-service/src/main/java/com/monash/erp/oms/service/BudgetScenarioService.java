...
import com.monash.erp.oms.repository.BudgetScenarioRepository;
...
public class BudgetScenarioService {
    ...
    public BudgetScenario get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "BudgetScenario %d not found".formatted(id)));
    }
