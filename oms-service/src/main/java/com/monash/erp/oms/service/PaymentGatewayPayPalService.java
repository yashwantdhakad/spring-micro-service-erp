...
import com.monash.erp.oms.repository.PaymentGatewayPayPalRepository;
...
public class PaymentGatewayPayPalService {
    ...
    public PaymentGatewayPayPal get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PaymentGatewayPayPal %d not found".formatted(id)));
    }
