...
import com.monash.erp.oms.repository.GeoAssocTypeRepository;
...
public class GeoAssocTypeService {
    ...
    public GeoAssocType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GeoAssocType %d not found".formatted(id)));
    }
