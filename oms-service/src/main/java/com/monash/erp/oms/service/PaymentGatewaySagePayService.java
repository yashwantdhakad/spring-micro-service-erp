...
import com.monash.erp.oms.entity.PaymentGatewaySagePay;
import com.monash.erp.oms.repository.PaymentGatewaySagePayRepository;
...
public class PaymentGatewaySagePayService {
    ...
    public PaymentGatewaySagePay get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PaymentGatewaySagePay %d not found".formatted(id)));
    }
