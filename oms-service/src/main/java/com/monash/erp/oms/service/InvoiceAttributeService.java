...
import com.monash.erp.oms.repository.InvoiceAttributeRepository;
...
public class InvoiceAttributeService {
    ...
    public InvoiceAttribute get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "InvoiceAttribute %d not found".formatted(id)));
    }
