...
import com.monash.erp.oms.repository.GlAccountTypeRepository;
...
public class GlAccountTypeService {
    ...
    public GlAccountType get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlAccountType %d not found".formatted(id)));
    }
