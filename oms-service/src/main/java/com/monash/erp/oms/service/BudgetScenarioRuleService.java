...
import com.monash.erp.oms.entity.BudgetScenarioRule;
import com.monash.erp.oms.repository.BudgetScenarioRuleRepository;
...
public class BudgetScenarioRuleService {
    ...
    public BudgetScenarioRule get(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "BudgetScenarioRule %d not found".formatted(id)));
    }
