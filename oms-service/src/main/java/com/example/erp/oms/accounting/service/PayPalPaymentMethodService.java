...
import com.example.erp.oms.accounting.domain.PayPalPaymentMethod;
import com.example.erp.oms.accounting.repository.PayPalPaymentMethodRepository;
...
public class PayPalPaymentMethodService {
    ...
    public PayPalPaymentMethod get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PayPalPaymentMethod %d not found".formatted(id)));
    }
