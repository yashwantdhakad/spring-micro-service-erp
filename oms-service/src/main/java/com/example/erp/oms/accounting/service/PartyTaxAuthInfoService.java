...
import com.example.erp.oms.accounting.repository.PartyTaxAuthInfoRepository;
...
public class PartyTaxAuthInfoService {
    ...
    public PartyTaxAuthInfo get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PartyTaxAuthInfo %d not found".formatted(id)));
    }
