...
import com.example.erp.oms.accounting.repository.TaxAuthorityCategoryRepository;
...
public class TaxAuthorityCategoryService {
    ...
    public TaxAuthorityCategory get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "TaxAuthorityCategory %d not found".formatted(id)));
    }
