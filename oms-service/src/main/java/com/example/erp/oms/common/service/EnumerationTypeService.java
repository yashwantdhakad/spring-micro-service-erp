...
import com.example.erp.oms.common.domain.EnumerationType;
import com.example.erp.oms.common.repository.EnumerationTypeRepository;
...
public class EnumerationTypeService {
    ...
    public EnumerationType get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "EnumerationType %d not found".formatted(id)));
    }
