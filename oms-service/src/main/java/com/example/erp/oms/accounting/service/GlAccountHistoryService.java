...
import com.example.erp.oms.accounting.repository.GlAccountHistoryRepository;
...
public class GlAccountHistoryService {
    ...
    public GlAccountHistory get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlAccountHistory %d not found".formatted(id)));
    }
