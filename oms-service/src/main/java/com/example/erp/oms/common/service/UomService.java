...
import com.example.erp.oms.common.repository.UomRepository;
...
public class UomService {
    ...
    public Uom get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Uom %d not found".formatted(id)));
    }
