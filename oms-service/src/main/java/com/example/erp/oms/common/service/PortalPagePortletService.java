...
import com.example.erp.oms.common.domain.PortalPagePortlet;
import com.example.erp.oms.common.repository.PortalPagePortletRepository;
...
public class PortalPagePortletService {
    ...
    public PortalPagePortlet get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PortalPagePortlet %d not found".formatted(id)));
    }
