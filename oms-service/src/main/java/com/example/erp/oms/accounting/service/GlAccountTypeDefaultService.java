...
import com.example.erp.oms.accounting.repository.GlAccountTypeDefaultRepository;
...
public class GlAccountTypeDefaultService {
    ...
    public GlAccountTypeDefault get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlAccountTypeDefault %d not found".formatted(id)));
    }
