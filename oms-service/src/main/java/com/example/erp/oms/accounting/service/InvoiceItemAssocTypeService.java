...
import com.example.erp.oms.accounting.repository.InvoiceItemAssocTypeRepository;
...
public class InvoiceItemAssocTypeService {
    ...
    public InvoiceItemAssocType get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "InvoiceItemAssocType %d not found".formatted(id)));
    }
