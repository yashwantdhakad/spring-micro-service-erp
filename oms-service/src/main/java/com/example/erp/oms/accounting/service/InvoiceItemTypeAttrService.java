...
import com.example.erp.oms.accounting.repository.InvoiceItemTypeAttrRepository;
...
public class InvoiceItemTypeAttrService {
    ...
    public InvoiceItemTypeAttr get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "InvoiceItemTypeAttr %d not found".formatted(id)));
    }
