...
import com.example.erp.oms.accounting.repository.InvoiceItemTypeMapRepository;
...
public class InvoiceItemTypeMapService {
    ...
    public InvoiceItemTypeMap get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "InvoiceItemTypeMap %d not found".formatted(id)));
    }
