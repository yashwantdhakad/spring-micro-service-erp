...
import com.example.erp.oms.accounting.domain.BudgetReviewResultType;
import com.example.erp.oms.accounting.repository.BudgetReviewResultTypeRepository;
...
public class BudgetReviewResultTypeService {
    ...
    public BudgetReviewResultType get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "BudgetReviewResultType %d not found".formatted(id)));
    }
