...
import com.example.erp.oms.accounting.domain.PaymentTypeAttr;
import com.example.erp.oms.accounting.repository.PaymentTypeAttrRepository;
...
public class PaymentTypeAttrService {
    ...
    public PaymentTypeAttr get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PaymentTypeAttr %d not found".formatted(id)));
    }
