...
import com.example.erp.oms.accounting.repository.InvoiceTermAttributeRepository;
...
public class InvoiceTermAttributeService {
    ...
    public InvoiceTermAttribute get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "InvoiceTermAttribute %d not found".formatted(id)));
    }
