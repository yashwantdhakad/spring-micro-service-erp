...
import com.example.erp.oms.accounting.repository.FinAccountStatusRepository;
...
public class FinAccountStatusService {
    ...
    public FinAccountStatus get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FinAccountStatus %d not found".formatted(id)));
    }
