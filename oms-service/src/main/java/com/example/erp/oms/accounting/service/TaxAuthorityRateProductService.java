...
import com.example.erp.oms.accounting.domain.TaxAuthorityRateProduct;
import com.example.erp.oms.accounting.repository.TaxAuthorityRateProductRepository;
...
public class TaxAuthorityRateProductService {
    ...
    public TaxAuthorityRateProduct get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "TaxAuthorityRateProduct %d not found".formatted(id)));
    }
