...
import com.example.erp.oms.accounting.repository.InvoiceItemTypeGlAccountRepository;
...
public class InvoiceItemTypeGlAccountService {
    ...
    public InvoiceItemTypeGlAccount get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "InvoiceItemTypeGlAccount %d not found".formatted(id)));
    }
