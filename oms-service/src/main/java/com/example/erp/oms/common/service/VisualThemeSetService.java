...
import com.example.erp.oms.common.domain.VisualThemeSet;
import com.example.erp.oms.common.repository.VisualThemeSetRepository;
...
public class VisualThemeSetService {
    ...
    public VisualThemeSet get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "VisualThemeSet %d not found".formatted(id)));
    }
