...
import com.example.erp.oms.accounting.domain.FinAccountTransType;
import com.example.erp.oms.accounting.repository.FinAccountTransTypeRepository;
...
public class FinAccountTransTypeService {
    ...
    public FinAccountTransType get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FinAccountTransType %d not found".formatted(id)));
    }
