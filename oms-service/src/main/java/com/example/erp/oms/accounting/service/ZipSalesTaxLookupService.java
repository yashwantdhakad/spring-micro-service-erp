...
import com.example.erp.oms.accounting.repository.ZipSalesTaxLookupRepository;
...
public class ZipSalesTaxLookupService {
    ...
    public ZipSalesTaxLookup get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "ZipSalesTaxLookup %d not found".formatted(id)));
    }
