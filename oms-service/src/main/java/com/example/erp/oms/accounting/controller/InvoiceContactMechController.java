...
import com.example.erp.oms.accounting.domain.InvoiceContactMech;
import com.example.erp.oms.accounting.service.InvoiceContactMechService;
...
@RestController
@RequestMapping("/accounting/invoice-contact-mechs")
