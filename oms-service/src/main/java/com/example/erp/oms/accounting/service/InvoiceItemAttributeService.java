...
import com.example.erp.oms.accounting.repository.InvoiceItemAttributeRepository;
...
public class InvoiceItemAttributeService {
    ...
    public InvoiceItemAttribute get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "InvoiceItemAttribute %d not found".formatted(id)));
    }
