...
import com.example.erp.oms.accounting.repository.TaxAuthorityAssocRepository;
...
public class TaxAuthorityAssocService {
    ...
    public TaxAuthorityAssoc get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "TaxAuthorityAssoc %d not found".formatted(id)));
    }
