...
import com.example.erp.oms.accounting.repository.FixedAssetTypeRepository;
...
public class FixedAssetTypeService {
    ...
    public FixedAssetType get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FixedAssetType %d not found".formatted(id)));
    }
