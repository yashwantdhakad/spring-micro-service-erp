...
import com.example.erp.oms.accounting.domain.GlAccountCategoryType;
import com.example.erp.oms.accounting.repository.GlAccountCategoryTypeRepository;
...
public class GlAccountCategoryTypeService {
    ...
    public GlAccountCategoryType get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlAccountCategoryType %d not found".formatted(id)));
    }
