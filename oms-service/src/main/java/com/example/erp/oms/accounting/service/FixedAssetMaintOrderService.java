...
import com.example.erp.oms.accounting.repository.FixedAssetMaintOrderRepository;
...
public class FixedAssetMaintOrderService {
    ...
    public FixedAssetMaintOrder get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FixedAssetMaintOrder %d not found".formatted(id)));
    }
