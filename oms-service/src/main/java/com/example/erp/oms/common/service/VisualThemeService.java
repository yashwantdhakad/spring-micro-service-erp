...
import com.example.erp.oms.common.domain.VisualTheme;
import com.example.erp.oms.common.repository.VisualThemeRepository;
...
public class VisualThemeService {
    ...
    public VisualTheme get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "VisualTheme %d not found".formatted(id)));
    }
