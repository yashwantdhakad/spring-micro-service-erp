...
import com.example.erp.oms.common.domain.PortletAttribute;
import com.example.erp.oms.common.repository.PortletAttributeRepository;
...
public class PortletAttributeService {
    ...
    public PortletAttribute get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "PortletAttribute %d not found".formatted(id)));
    }
