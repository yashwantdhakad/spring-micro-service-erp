...
import com.example.erp.oms.accounting.domain.AccommodationClass;
import com.example.erp.oms.accounting.repository.AccommodationClassRepository;
...
public class AccommodationClassService {
    ...
    public AccommodationClass get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "AccommodationClass %d not found".formatted(id)));
    }
