...
import com.example.erp.oms.accounting.repository.InvoiceItemAssocRepository;
...
public class InvoiceItemAssocService {
    ...
    public InvoiceItemAssoc get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "InvoiceItemAssoc %d not found".formatted(id)));
    }
