...
import com.example.erp.oms.accounting.repository.GlReconciliationRepository;
...
public class GlReconciliationService {
    ...
    public GlReconciliation get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlReconciliation %d not found".formatted(id)));
    }
