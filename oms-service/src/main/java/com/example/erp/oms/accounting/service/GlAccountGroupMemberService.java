...
import com.example.erp.oms.accounting.repository.GlAccountGroupMemberRepository;
...
public class GlAccountGroupMemberService {
    ...
    public GlAccountGroupMember get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlAccountGroupMember %d not found".formatted(id)));
    }
