...
import com.example.erp.oms.accounting.repository.FinAccountTypeRepository;
...
public class FinAccountTypeService {
    ...
    public FinAccountType get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FinAccountType %d not found".formatted(id)));
    }
