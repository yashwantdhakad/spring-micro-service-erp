...
import com.example.erp.oms.accounting.repository.FixedAssetGeoPointRepository;
...
public class FixedAssetGeoPointService {
    ...
    public FixedAssetGeoPoint get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "FixedAssetGeoPoint %d not found".formatted(id)));
    }
