...
import com.example.erp.oms.accounting.repository.GlAccountCategoryRepository;
...
public class GlAccountCategoryService {
    ...
    public GlAccountCategory get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "GlAccountCategory %d not found".formatted(id)));
    }
