...
import com.example.erp.oms.accounting.repository.BudgetItemAttributeRepository;
...
public class BudgetItemAttributeService {
    ...
    public BudgetItemAttribute get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "BudgetItemAttribute %d not found".formatted(id)));
    }
