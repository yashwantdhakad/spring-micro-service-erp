...
import com.example.erp.oms.accounting.service.BudgetService;
...
public class BudgetController {
    ...
    public ResponseEntity<Budget> create(@RequestBody Budget entity) {
        Budget created = service.create(entity);
        return ResponseEntity.status(HttpStatus.CREATED).body(created);
    }

    @PutMapping("/{id}")
    public Budget update(@PathVariable Long id, @RequestBody Budget entity) {
