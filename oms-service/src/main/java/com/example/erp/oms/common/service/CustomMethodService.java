...
import com.example.erp.oms.common.domain.CustomMethod;
import com.example.erp.oms.common.repository.CustomMethodRepository;
...
public class CustomMethodService {
    ...
    public CustomMethod get(Long id) {
        return repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "CustomMethod %d not found".formatted(id)));
    }
